...
exports.config = {
    ...
    specs: [testPattern],
    suites: {
        login: ['./specs/Login/Login_test.js'],
        newplace: ['./specs/NewPlace/NewPlace_test.js'],
        registration: ['./specs/UserRegistration/UserRegistration_test.js'],
        visited: ['./specs/Visited/visited_test.js'],
        mylist: ['./specs/MyLists/MyList_test.js'],
        dev: [testDevPattern]
    },
    // Patterns to exclude.
    exclude: [
